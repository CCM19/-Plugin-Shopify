    ...
    translation: {
      form: {
        field: {
          ...
          emptyInputMessage: "Eingabe leer. Bitte geben Sie Ihren Code-Schnipsel ein. Danke.",
          deleteMessage: "Script wurde aus dem Template gelöscht",
          internalErrorMessage: "Ein Interner Fehler ist aufgetreten. Bitte wenden Sie sich an den Support. Danke für Ihr Verständnis.",
        },
      },
    },
  },
    ...
    translation: {
      form: {
        field: {
          ...
          successMessage: "The code-snippet has been successful integrated.",
          emptyInputMessage: "Empty input. Pleas enter your CCM19 code.",
          deleteMessage:"Script deleted from Template",
          internalErrorMessage: "Internal error. Pleas contact support.",
        },
      },
    },
  },
